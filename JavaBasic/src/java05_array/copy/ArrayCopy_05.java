...
//		String.format("서식 문자열", 데이터);
		// 서식 문자열에 맞게 데이터를 서식화하고 String타입으로 반홚나다.
		
		String str = String.format("%d점입니다",100);
		...
		System.out.println(String.format("%10d 값 출력", 12321));
		System.out.println(String.format("%10d 값 출력", 12312312));
		...
		System.out.println(String.format("%10.4f", 1234567.8912345));
	
		System.out.println(String.format("%.2f", 1234567.8912345));
		
		System.out.printf("%d%s", 12212,"Hello");
